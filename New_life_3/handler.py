...
@dp.message_handler(Text(equals='Как можно провести время на улице ?🚶‍♂🚶‍♀', ignore_case=True), state=None)
...
@dp.message_handler(state=DataFilms.Film_cimema)
...
@dp.message_handler(Text(equals='Сыграть в игру🔮', ignore_case=True), state=None)
...
@dp.callback_query_handler(text='back_call', state='*')
...
@dp.message_handler(Text(equals='На какой фильм в кинотеатр можно сходить ?🎬', ignore_case=True), state=None)
...
@dp.message_handler(content_types=["location"], state=DataCinema.Loc_cinema)
...
@dp.message_handler(Text(equals='Куда можно сходить поесть ?🍽', ignore_case=True), state=None)
...
@dp.message_handler(content_types=["location"], state=DataRestaurant.Loc_restaurant)
...
@dp.message_handler(Text(equals='Где и какой кофе можно выпить?☕️', ignore_case=True), state=None)
...
@dp.message_handler(content_types=["location"], state=DataCoffee.Loc_coffee)
...
@dp.message_handler(Text(equals='Выбрать другой город🏙️🌃', ignore_case=True), state=None)
...
@dp.message_handler(state=Other.Other_city)
